...
?>
    ...
    <main class="contenedor seccion">
        ...
        <?php healthPilates_lista_clases(4); ?>
    ...
    <section class="testimoniales">
        <h2 class="text-center text-blanco">Testimonios<h2>
         <div class="contenedor-testimoniales swiper">
        <?php healthPilates_testimoniales(); ?>
        </div>
    </section>

    <section class="contenedor seccion">
        <h2 class="text-center text-primary">Nuestro Blog</h2>
        <p class="text-center">Aprende nuestros tips<p>
